...
- [ReadAware](https://github.com/ahpxex/read-aware) - Self-evolving, agent-first ebook reader that understands you better with every book, highlight, and conversation.

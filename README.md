...
- [OpenMarkdown](https://openmarkdown.dev) ![closed source] ![v2] - Local-first Markdown editor that lets you and your coding agent co-edit the same file, with a built-in MCP server and Claude Code plugin.

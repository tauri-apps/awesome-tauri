...
- [tauri-plugin-macos-permissions](https://github.com/ayangweb/tauri-plugin-macos-permissions) - Check and request macos permissions to accessibility, full disk access and screen recording.

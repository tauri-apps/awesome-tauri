...
- [CC View](https://github.com/Ethanzyc/cc-view) - macOS menubar app for monitoring Claude Code sessions across terminals — status overview, command palette, precise tab focus, token stats.

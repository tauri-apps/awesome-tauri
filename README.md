...
- [OratioText](https://github.com/kylethedeveloper/OratioText) ![v2] - Cross-platform desktop app for converting speech-to-text using OpenAI's Whisper model locally.

...
- [EzUp](https://github.com/HuakunShen/ezup) - File/Image uploader. Upload link/path/screenshot in clipboard get a link in clipboard. Designed for blog writing and note taking.
### Closed Source

...
- [QueryLoL](https://github.com/ishtartec/query-lol-desktop) ![v2] - League of Legends companion with per-level game plans, auto-applied builds, draft intelligence, smurf detection, and post-game analysis.

...
- [Oleafly](https://oleafly.com) ![v2] - Open-source, AI-powered Overleaf alternative, research workspace and editor for LaTeX, Typst, and Markdown with live-compiled PDFs, citations, TikZ diagrams, and Git history.

...
- [NoteGen](https://github.com/codexu/note-gen) ![v2] - Open-source, local-first Markdown note-taking app that turns scattered records into structured notes with AI.

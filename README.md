...
- [SocketSweep](https://github.com/VishnuSrivatsava/SocketSweep) - High-performance Android storage analyzer that bypasses MTP using a native C++ daemon and a Rust TCP bridge.

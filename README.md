...
- [NoteCapt](https://github.com/kasingbbb/NoteCapt) ![closed source] ![v2] - Converts, organizes and indexes study materials into local Markdown, connectable to AI assistants over MCP.

...
- [OxideTerm](https://github.com/AnalyseDeCircuit/oxideterm) ![v2] - Cross-platform terminal workspace with local shells, SSH, SFTP, remote code editing, AI assistant, port forwarding, plugins, and 30+ themes, built on pure `russh`.

...
- [tauri-plugin-notifications](https://github.com/Choochmeque/tauri-plugin-notifications) ![v2] - Notifications plugin for desktop and mobile with scheduling, actions, channels, and push support.

...
- [CC View](https://github.com/Ethanzyc/cc-view) ![v2] - macOS menubar app for monitoring Claude Code sessions across terminals — status overview, command palette, precise tab focus, token stats.

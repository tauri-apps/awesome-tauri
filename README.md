...
- [tauri-plugin-background-service](https://github.com/dardourimohamed/tauri-background-service) ![v2] - Manage long-lived background service lifecycle across Android, iOS, and desktop.

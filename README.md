...
- [Deep Face Cam](https://github.com/DeepFaceCamLabs/deep-face-cam) ![v2] - Local face-swap application for images, videos, and live camera feeds with on-device processing.

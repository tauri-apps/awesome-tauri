...
- [tauri-plugin-webdriver](https://github.com/Choochmeque/tauri-plugin-webdriver) ![v2] - W3C WebDriver plugin for automated testing with Selenium, WebdriverIO, Playwright, and other clients.

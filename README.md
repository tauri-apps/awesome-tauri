...
- [tauri-react-template](https://github.com/Donovan-Ye/tauri-react-template) - Opinionated template for building Tauri apps using React, Typescript, React-router, tailwindcss, i18n, ant-design-v5, vite, and more.

...
- [tauri-solid-ts-tailwind-vite-template](https://github.com/AR10Dev/tauri-solid-ts-tailwind-vite) - Solid template with Vite + HMR, TypeScript, Tailwind CSS, ESLint, Prettier, file based routing and cross-platform GitHub Actions builds.

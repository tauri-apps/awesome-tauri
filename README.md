...
- [Wrolp Terminal](https://github.com/wrolp/wrolp) ![v2] - An open-source desktop SSH terminal and server-ops tool — multi-tab, SFTP, remote editor, session recording, Docker analysis & AI assistant.

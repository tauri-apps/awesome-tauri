...
- [MDHero](https://github.com/vaibhavuk-dev/mdhero) ![v2] - Reading-first native Markdown viewer/editor for macOS and Windows. LLM paste mode, KaTeX, Mermaid, Vim keybindings, ~8MB.

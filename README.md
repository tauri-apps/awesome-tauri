...
- [tauri-plugin-mcp](https://github.com/p3gleg/tauri-plugin-mcp) - Enables AI agents to debug Tauri apps via screenshots, window control, DOM access, user input simulation, and JavaScript execution.

...
- [axios-tauri-api-adapter](https://github.com/persiliao/axios-tauri-api-adapter) - Makes it easy to use Axios in Tauri **Support javascript & typescript**, `axios` adapter for the `@tauri-apps/api/http` module.

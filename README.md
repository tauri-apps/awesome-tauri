...
- [Prevail](https://github.com/fru-dev3/prevail-desktop) ![v2] - Local-first AI life OS that runs Claude, Codex, Gemini or Ollama per life-domain over a plain-markdown vault.

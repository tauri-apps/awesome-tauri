...
- [Hindsight](https://github.com/Tomotsugu-dev/Hindsight) ![v2] - Local-first desktop activity tracker with an hourly Screen-Time-style timeline and offline AI daily summaries via llama.cpp.

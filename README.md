...
- [HardwareVisualizer](https://github.com/shm11C3/HardwareVisualizer) - Hardware monitor with persistent historical data, customizable dashboard, and flexible graph themes.

...
- [Harbor](https://github.com/luke-fairbanks/harbor-mcp) ![v2] - Mac control center that inventories local servers, flags likely duplicate projects, and lets AI agents operate approved development stacks through MCP.

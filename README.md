...
- [GitWand](https://github.com/devlint/GitWand) - Desktop Git client with automatic conflict resolution, merge preview, inline code review, and AI-assisted workflow.

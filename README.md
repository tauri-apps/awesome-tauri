...
- [Github Security Alerts](https://github.com/stephanebouget/github-security-alerts) - Desktop application that monitors security vulnerabilities across your GitHub repositories in real-time.

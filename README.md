...
- [BBARIT](https://github.com/bbarit/terminal) ![v2] ![closed source] - Native all-in-one AI coding IDE with multi-agent terminals, office editing, and an agent-driven browser; bring any model or run local with `Ollama`.

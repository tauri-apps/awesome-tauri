...
- [tauri-plugin-auth-session](https://github.com/yanqianglu/tauri-plugin-auth-session) ![v2] - In-app OAuth and OIDC on iOS, macOS, and Android using ASWebAuthenticationSession and Chrome Custom Tabs, with PKCE support.

...
- [VIBE OS](https://github.com/TPal126/vibe-os) ![v2] - Reasoning-first AI coding IDE running the Claude Agent SDK
  with knowledge graph context injection and custom MCP tools.
